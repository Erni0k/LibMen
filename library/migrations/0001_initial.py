# Generated by Django 6.0.3 on 2026-05-06 22:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(default='czytelnik', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('available', 'Dostępna'), ('borrowed', 'Wypożyczona'), ('reserved', 'Zarezerwowana'), ('damaged', 'Uszkodzona'), ('lost', 'Zagubiona')], default='available', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'Aktywna'), ('fulfilled', 'Zrealizowana'), ('cancelled', 'Anulowana'), ('expired', 'Wygasła')], default='active', max_length=20)),
